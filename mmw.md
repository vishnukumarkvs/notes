...
===
  ...
  1. Compile & Package:
  Run the build script to compile the application and construct the bundle directory:
    cd /Users/kvsvishnukumar/VishnuKvs/Workspace/projects/mmw
    chmod +x build.sh
    ./build.sh

  2. Launch:
  Double-click or run the packaged application:
    open MMW.app
